...
\geometry{a4paper, margin=1.1in, bindingoffset=0.6in}
...
I would also like to extend my sincere thanks to our project coordinators \textbf{Prof. P. S. Sajjanshetti} and \textbf{Prof. M. B. Yelpale} for their guidance, encouragement, and timely feedback throughout the project.
\vspace*{1.1\baselineskip}
...
\small % reduce font size to fit better
